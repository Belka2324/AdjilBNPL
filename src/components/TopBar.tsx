import { Search, Bell, LogOut, X, User, Settings, Key, Camera, Loader2 } from 'lucide-react'
...
export default function TopBar({ role, username, onLogout, isCEO }: Props) {
  ...
  const roleColor = 
    role === 'administrator' 
      ? isCEO ? 'bg-red-100 text-red-700 border-red-200' : 'bg-purple-100 text-purple-700 border-purple-200' :
              ...
              <div className="space-y-4">
                ...
                <div className="pt-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <button className="px-4 py-3 bg-slate-100 rounded-xl text-sm text-slate-600 hover:bg-slate-200 transition-colors">
                      تغيير
                    </button>
                  </div>
                </div>
